...
public class SelectableRoundedImageView extends ImageView {
    ...
    static class SelectableRoundedCornerDrawable extends Drawable {
        ...
        public static Drawable fromDrawable(Drawable drawable, Resources r) {
    	    ...
    	    // 为了防止宽高不相等，造成图片变形，因此截取长方形中处于中间位置最大的正方形图片
     		...
     		Drawable mydrawable =new BitmapDrawable(squareBitmap);
        	
            if (mydrawable != null) {
                if (mydrawable instanceof SelectableRoundedCornerDrawable) {
                    return mydrawable;
                } else if (mydrawable instanceof LayerDrawable) {
                    LayerDrawable ld = (LayerDrawable) mydrawable;
                ...
                Bitmap bm = drawableToBitmap(mydrawable);
                if (bm != null) {
