...
public class ResidentNotificationHelper {
    ...
    @TargetApi(16)
    public static void sendResidentNoticeType0(Context context, String title, String content, int res) {
        ...
        remoteViews.setImageViewResource(R.id.icon_iv, R.drawable.notelogo);
        ...
        builder.setSmallIcon(R.drawable.notelogo);
    ...
    public static void sendDefaultNotice(Context context, String title, String content, int res) {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context);
        builder.setOngoing(true);
        builder.setPriority(NotificationCompat.PRIORITY_MAX);
