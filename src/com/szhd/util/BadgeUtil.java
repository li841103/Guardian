...
public class BadgeUtil {
    ...
    public static void setBadgeCount(Context context, int count) {
        ...
        } else if (Build.MANUFACTURER.equalsIgnoreCase("sony")) {//不考虑sony大小写
            sendToSony(context, count);
        } else if (Build.MANUFACTURER.toLowerCase().contains("samsung")) {//字符串里包含samsung
            sendToSamsumg(context, count);
        } else if(Build.MANUFACTURER.equalsIgnoreCase("Freescale")){
