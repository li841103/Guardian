...
public class ElectricFenceActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.electricfence);
		init();
	}
	...
	private void init() {
		...
		finish.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				//传递数据
				Intent intent = new Intent(ElectricFenceActivity.this, FunctionActivity.class);
				...
				efb.setDATE(list);
				intent.putExtra("BackElectricFenceActivity", efb);
		...
		oldtime.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
                TimePickerDialog timePickerDialog = new TimePickerDialog(ElectricFenceActivity.this,
		...
		ElectricFenceBean efbj = (ElectricFenceBean) intent.getSerializableExtra("JumpElectricFenceActivity");  
		if(efbj != null){
		...
		ElectricFenceBean efba = (ElectricFenceBean) intent.getSerializableExtra("AddElectricFenceActivity");  
		if(efba != null){
			for(int i=0; i<7; i++){
