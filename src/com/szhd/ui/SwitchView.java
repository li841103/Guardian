...
public class SwitchView extends View{
   ...
   @Override protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
      ...
      int heightSize = (int) (widthSize * 0.5333f);//设置长宽比例
   ...
   @Override protected void onSizeChanged(int w, int h, int oldw, int oldh) {
      ...
      sLeft = sTop = 0;
      sRight = mWidth;
      sBottom = mHeight * 1f;//田径场底部 占全身的百分之八十， 下面预留百分之二十的空间画按钮阴
      sWidth = sRight - sLeft;
   ...
   @Override protected void onDraw(Canvas canvas) {
      ...
      paint.setColor(isOn ? 0xff12b7f5 : 0xffcccccc);
      //画背景
      ...
      canvas.save();
      //放大,调节白色操场形状和面积
      canvas.scale(scale, scale-0.05f, sCenterX + scaleOffset, sCenterY);
